 ...
 * {@link com.winfiny.cb.KeyboardFragment.OnKeyboardFragmentInteractionListener} interface
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.keyboard_view, container, false);
        ButterKnife.inject(this, v);

        Keyboard mKeyboard = new Keyboard(getActivity(), R.xml.qwerty);
    ...
    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView.OnKeyboardActionListener() {
        @Override public void onKey(int primaryCode, int[] keyCodes) {
            ...
            mListener.onKeyPressed(primaryCode);
        }
